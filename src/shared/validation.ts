...
export function validateUsername(username: string) {
    ...
    if (username.length > 64)
        errors.push({ field: 'username', message: "Name must be at most 64 characters long" });
...
export function validateModName(modName: string) {
    ...
    if (name.length > 64) {
      errors.push({ field: 'name', message: "Mod name must be less than 64 characters long."});
    }
  ...
  export function validateModDescription(modDescription: string) {
    ...
    if (description.length < 3) {
      errors.push({ field: 'description', message: "Mod description must be at least 3 characters long."});
    }
  ...
  export function validateModShortDescription(modShortDescription: string) {
    ...
    if (shortDescription.length < 3) {
      errors.push({ field: 'shortDescription', message: "Mod description must be at least 3 characters long."});
    }
    if (shortDescription.length > 200) {
      errors.push({ field: 'shortDescription', message: "Mod description must be less than 200 characters long. ("+modShortDescription.length+")"});
    }
    return errors;
  }